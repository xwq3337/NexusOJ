...
export const userApi = {
  ...
  RefreshToken: (): Promise<{
    ...
    return axios.get("/service/user/refresh", {
      headers: {
  ...
  updatePassword: (
    ...
    return Request.post("/user/update-password", {
      old_password,
      new_password,
    });
  },
  ...
  getUserRecordList: (
    ...
    ApiResponse<{ records: GetRecordListResponse[]; total: number }>
  > => {
  ...
  getRecommendations: (
    ...
    ApiResponse<{ problems: RecommendedProblem[]; total: number }>
  > => {
    return Request.get(`/recommend/problems`, {
